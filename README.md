...
- **首页（/index.html）**：实时预览页面，显示摄像头视频流，提供基本控制功能
- **设备管理（/cameras.html）**：管理摄像头设备，查看设备信息，控制设备参数
- **摄像头选择（/camera_select.html）**：选择和配置摄像头，设置分辨率、帧率等参数
- **系统信息（/system_info.html）**：显示系统状态信息，包括CPU、内存、磁盘使用情况等
